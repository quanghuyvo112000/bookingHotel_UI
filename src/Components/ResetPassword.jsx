...
const ResetPassword = () => {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      const response = await axios.put('https://localhost:7211/Account/resetPassword', {
        email: email,
        token: token,
      ...
      console.error('Lỗi khi đặt lại mật khẩu:', error.response ? error.response.data.message : error.message);
