...
const ListHotel = () => {
  ...
  return (
    <div>
      ...
      <div className="row">
        <div className="col-12 col-md-3 filter-hotel">
        ...
        <div className="col-12 col-md-9" style={{marginLeft: '270px', width: '79%'}}>
          <div className="row">
            {hotels
                ...
                <div key={hotel.id}>
                  <div className="card card-hotel">
                    <div className="row">
                      ...
                      <div style={{ paddingLeft: '60px' }} className="card-body col-md-7 ">
                      ...
                      <div style={{ borderLeft: '1px solid #d2d2d2', borderRadius: '0.375rem', padding: 15 }} className="col-md-2">
                        {renderPrice(hotel)}
                        <br />
                        <button className="btn btn-primary" onClick={() => handleBookRoom(hotel.id)}>
                          Chọn phòng
                        </button>
                      </div>
                    </div>
