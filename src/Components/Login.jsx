              ...
              <form onSubmit={handleRegister}>
                ...
                <div className="form-check">
                  <div className='rules' style={{borderRadius: 5, lineHeight: 2.5, fontWeight: 400, color: 'black', border: '1px solid #dee2e6', scrollBehavior: 'smooth', overflow: 'auto', width: '100%', height: 150, margin: '15px 0', padding: 10, fontSize: 9}}>
                    ...
                    <span> + Tiêu chuẩn và Hướng dẫn về Nội dung giúp chúng tôi duy trì mọi nội dung trên Nền tảng sao cho liên quan và phù hợp với người truy cập toàn cầu mà không hạn chế tự do ngôn luận. Tài liệu đó cho biết cách chúng tôi quản lý nội dung và các hành động khi có nội dung không phù hợp.</span><br/>
                    <span> + Khi đồng ý với các Điều khoản của chúng tôi, bạn đồng ý với tất cả nội dung trong cả ba tài liệu. Nếu bạn không chấp nhận bất kỳ Điều khoản nào trong các Điều khoản này, vui lòng không sử dụng Nền tảng của chúng tôi.</span><br/>
                    <span> + Tất cả thông tin này (cùng email xác nhận đơn đặt và mọi thông tin được cung cấp trong giai đoạn tiền hợp đồng trước khi bạn đặt chỗ) đều quan trọng vì chúng quy định các điều khoản pháp lý mà căn cứ trên đó các Nhà cung cấp Dịch vụ cung cấp Trải nghiệm Du lịch thông qua Nền tảng của chúng tôi.</span><br/>
                    <span> + Nếu xảy ra vấn đề với Trải nghiệm Du lịch của bạn, Mục A15 trong các Điều khoản này sẽ giải thích những gì bạn có thể làm để giải quyết vấn đề đó. Điều đó bao gồm khiếu nại với chúng tôi, đưa ra tòa và (trong một số trường hợp) sử dụng dịch vụ giải quyết tranh chấp trực tuyến.</span><br/>
                    <span> + Nếu bạn muốn kháng nghị quyết định kiểm duyệt hoặc báo cáo bất kỳ nội dung nào trên Nền tảng của chúng tôi thì Tiêu chuẩn và Hướng dẫn về Nội dung sẽ giải thích cách kháng nghị hoặc báo cáo, cũng như cách chúng tôi quản lý các yêu cầu này.</span><br/>
                    <span> + Bản tóm tắt này không nằm trong các Điều khoản của chúng tôi hay một tài liệu pháp lý nào cả. Đây chỉ là phần giải thích đơn giản về các Điều khoản của chúng tôi. Chúng tôi khuyến khích bạn đọc toàn bộ nội dung của từng tài liệu. Một số từ trong bản tóm tắt này có ý nghĩa rất cụ thể, vì vậy vui lòng kiểm tra “Từ điển Booking.com” ở phần cuối các Điều khoản này.</span><br/>
                  </div>
                  <input
                    type="checkbox"
                ...
                <button
                  type="submit"
                  className={`btn btn-primary ${!registerFormData.agreeToTerms ? 'disabled' : ''}`}
                >
                  Đăng ký
                </button>
              </form>
